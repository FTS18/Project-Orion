...
export const LOAN_PRODUCTS: Record<string, LoanProduct> = {
  ...
  education: {
    id: "education",
    name: "Education Loan",
    description: "Loan for higher education in India or abroad",
    minAmount: 50000,
    maxAmount: 20000000,
    ...
    maxTenure: 180,
    defaultTenure: 60,
    tenureOptions: [12, 24, 36, 48, 60, 72, 84, 120, 180],
    ...
    processingFeeRate: 0,
    minProcessingFee: 0,
    minCreditScore: 0, // Often based on parent/guardian
    minAge: 18,
    maxAge: 35,
    minIncome: 0,
    isActive: true,
    requiresCollateral: true, // For higher amounts
  },
  gold: {
    id: "gold",
    name: "Gold Loan",
    ...
    maxTenure: 36,
    defaultTenure: 12,
    tenureOptions: [3, 6, 12, 18, 24, 36],
    baseInterestRate: 9.5,
    rateAdjustments: {
      excellent: 0,
      good: 0,
      fair: 0,
      poor: 0, // Gold loan rates often standard
    },
    processingFeeRate: 0.5,
    minProcessingFee: 500,
    minCreditScore: 0, // Collateral based
    minAge: 18,
    maxAge: 75,
    minIncome: 0,
    isActive: true,
